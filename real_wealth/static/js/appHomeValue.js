...
//     console.log(data)
    ...
    let dates = [];
    data.forEach(i => {
        // console.log(i.medianhomepricela)
        medhomepricela.push(i.medianhomepricela)
        medhomepriceus.push(i.medianhomepriceus)
    ...
    MedHoPrLa=median(medhomepricela);
    // console.log(MedHoPrLa)
    document.getElementById("insertMeHo").innerHTML = MedHoPrLa;
    // console.log(medrentpriceus)
    // // console.log(data);
    // console.log(medhomepricela)

    var trace1 = {
        x: dates,
        y: medhomepricela,
        mode: 'lines+markers',
        text: "Median Home Value LA",
        name: "LA County"
    };
    ...
    var layout1 = {
        ...
        width: 1650,
        height: 700,
        title: {text: "Los Angeles County vs United States Median Home Value"}
    };

    var hvtrace = [trace1, trace2]

    Plotly.newPlot('chart1', hvtrace, layout1)
})